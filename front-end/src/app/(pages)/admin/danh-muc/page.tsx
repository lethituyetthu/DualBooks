                        ...
                        {cate.map((category, index) => (
                            <tr key={category.id || index} className="border-b hover:bg-gray-100">
                                ...
                                <td className="py-2 px-4">
                                    <CategoryImage
                                        imageUrl={`http://localhost:3200/uploads/categories/${category.cate_image}`}
                                ...
                                <td className="py-2 px-4">
                                    ...
                                    <button onClick={() => handleDeleteCategory(category.id || "")} disabled={actionLoading} className="text-red-500 hover:underline">
