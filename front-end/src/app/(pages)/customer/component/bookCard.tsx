...
import { typeBook } from "../hook/useFetchBook";

export default function BookCard({ book }: { book: typeBook }) {
  return (
    <Link href={`/customer/product/${book.id}`}>
      <div className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-all duration-300 ease-in-out">
        ...
        />
        <h3 className="text-sm font-semibold text-center h-10 font-inter overflow-hidden text-ellipsis line-clamp-2">
          {book.title}
        </h3>
