...
export default function Showcategory() {
  ...
  if (loading) {
    return <div className="text-center">Loading...</div>; // Hiển thị thông báo khi đang tải
  }

  if (error) {
    return <div className="text-red-500 text-center">Error: {error}</div>; // Hiển thị thông báo lỗi
  }
